...
const people = [
  ...
  },
  {
    ...
    {
    "timestamp": "2019/01/15 6:07:50 PM GMT+3",
    "name": "Андрей Ляшко",
    "occupation": "Халявный ML фуллстек с бигдатой в Яндексе, когда-то писал алготрейдинг",
    "knowledge": "Яндекс, Worldquant, Кипр, Тайланд, Лошадка-party",
    "photo": "https://pp.userapi.com/c847018/v847018118/17b7ca/n777cewUH7U.jpg",
    "profiles": "@andrey_lyashko"
  },
  {
    "timestamp": "2019/01/15 6:54:18 PM GMT+3",
    "name": "Валера Харитонов",
    "occupation": "Занимался функциональным анализом в ВГУ, работал в провинциальном аутсорсинге, закончил ФКН и ШАД, стажировался в компьютерном зрении в Яндексе и в Asana, преподавал алгоритмы на ФКН и в ШАДе, писал научные статьи в bayesgroup.ru, выиграл H-1B, бросаю аспирантуру и уезжаю работать в Нью-Йорк фронтендером.",
    "knowledge": "Аспирантура, байесовский вывод, Воронеж, генеративные модели, дропаут, естественные языки, ё?, ж?, зрение, искусственный интеллект, й?, критика глубинного обучения, линейные операторы, машинное обучение, нейронные сети, обработка изображений, поиск похожих картинок, распределения вероятностей, Сан-Франциско, теория типов, учет расходов, функциональный анализ, х?, цифровое искусство, ч?, ШАД, щ?, ъ?, ы?, ь? эмиграция в США, ю?, Яндекс",
    "photo": "https://pp.userapi.com/c845323/v845323849/2d16c/Euq8FPfMpz0.jpg",
    "profiles": "@kharvd"
  },
  {
    "timestamp": "2019/01/15 6:57:16 PM GMT+3",
    "name": "Даша Яковлева ",
    "occupation": "Сейчас я работаю в skyeng продакт маркетинг менеджером. В свободное время изучаю data science, сognitive neuroscience и психологию, а также  работаю со своим друзьями над проектом  по повышению когнитивных способностей людей (делаем нейрогаджет с ээг+tdcs).  Занимаюсь самостоятельным ресечем по теме well-being, исследую все, что с этим связано со стороны психологии, биологии, философии. Интересно, в целом, насколько наука продвинулась в понимании и обосновании темы счастья.  Увлекаюсь футурологией и периодически читаю, смотрю и слушаю про будущее.  Окончила факультет бизнеса в РЭУ им. Плеханова. Какое-то время изучала современное искусство и философию. В прошлом году определилась с вектором жизни и ценностями, чему очень рада. ",
    "knowledge": "Меня можно расспрашивать про продакт менеджмент, повышение личной эффективности, здоровье, счастье, йогу, медитацию, современное искусство, философию, футурологию, кино, музыку и про современную культуру в целом.  Из стран могу рассказать про Ирландию, Турцию, США, Францию, Испанию. ",
    "photo": process.env.PUBLIC_URL + "/photos/yakovleva.jpg",
    "profiles": "Меня можно везде найти под ником @dashayakov\nfb: https://www.facebook.com/dashaayakov"
  },
  {
    "timestamp": "2019/01/15 7:26:27 PM GMT+3",
    "name": "Иван Лахтанов",
    "occupation": "Занимаюсь теорией приближений и выпуклой оптимизацией в аспирантуре мехмата МГУ.\nЗакончил ШАД, где разочаровался в ML, а, закончив, им заинтересовался.\nСтажировался в Google, Яндексе и Facebook, а сейчас разрабатываю платформу видеотрансляций в Яндексе (речь идет о терабитах!).",
    "knowledge": "Могу рассказать, как легко получать офферы в зарубежные гиганты и почему от них стоит отказываться (и почему нет).",
    "photo": "https://pp.userapi.com/c846416/v846416146/13e9ac/mEpKQsxI2AI.jpg",
    "profiles": "https://t.me/ivan_lakhtanov\nhttps://vk.com/ivan.lakhtanov"
  },
  {
    "timestamp": "2019/01/15 8:59:48 PM GMT+3",
    "name": "Паша Шевчук",
    "occupation": "делаю чуток эмэля, не великий эксперт, в последний раз этим займался в Samsung R&D Institute.",
    "knowledge": "Случайные вещи в случайном порядке:\n1. Конструкция автомагистралей (особенно британских)\n2. Кое-что про IT но тут много что всего знает\n3. Как уехать прямо завтра из Лондона в Честер за какие-то копейки на поезде и вообще как побеждать билеты\n4. ещё кое-какой рандомный треш",
    "photo": process.env.PUBLIC_URL + "/photos/shevchuk.jpg",
    "profiles": "телега у всех есть"
  },
  {
    "timestamp": "2019/01/15 10:21:11 PM GMT+3",
    "name": "Денис Тарасов",
    "occupation": "Учусь на ФКН Вышки. Работаю техническим менеджером-стажером в Яндексе, конкретно сейчас больше разработчик, чем менеджер. До этого еще летом стажировался в Дзене разработчиком.",
    "knowledge": "Есть опыт жизни в деревне и в маленьких русских городах. Иногда играю в алтимат. Работал на Почте России, когда был школьником.",
    "photo": process.env.PUBLIC_URL + "/photos/tarasov.jpg",
    "profiles": "https://www.linkedin.com/in/dennytarasov/ -- добавляйтесь!"
  },
  {
    "timestamp": "2019/01/16 3:17:36 AM GMT+3",
    "name": "Артур Лисс",
    "occupation": "После бакалавриата и стажировочки в Яндексе понял, что поработать кодером я всегда успею, а жизнь одна, и пошёл в магистратуру ШАД + ФКН. Начитался статеек и теперь хочу попробовать на вкус всякий разный ML.\n\nУчаствую в CTF-соревнованиях. Это такая весёлая альтернатива ACM, где нужно не решать алгоритмические задачки, а хакать и защищаться. Писал задачи для нескольких CTF.\n\nУчаствовал в студенческих соревнованиях по робототехнике, где мы каким-то образом прошли на финал во Францию вместе с секси-роботами команд Сбертеха и Сколтеха (наши роботы, разумеется, были из говна и палок, но в этом и шарм).\n\nНравятся математика, лингвистика, велопрогулки, виндсёрфинг и горные походы. Хочу научиться писать электронную музыку. Умею кататься на водном стульчике.",
    "knowledge": "Что такое CTF и как выглядит его проведение (спойлер: организаторы всё еле-еле доделывают к началу соревнований).\n\nКак проходят любительские соревнования по робототехнике (спойлер: участники всё еле-еле доделывают к концу соревнований).",
    "photo": process.env.PUBLIC_URL + "/photos/lis.jpg",
    "profiles": "t.me/artli\nvk.com/artli"
  }
];
